...
CapteurLumiereAnalogique capteur1(0); // Broche analogique sur laquellele capteur est branché 
...
// Création des zones
CapteurLumiereAnalogique capteursZone1[] = {capteur1, capteur2}; // création d'un tableau contenant tous les capteurs d'une zone
Zone zone1(capteursZone1, 3, 13); // création de zone1 (zone à laquelle le capteur appartient, nbr de capteurs dans la zone, broche sur laquelle la led est branchée)

CapteurLumiereAnalogique capteursZone2[] = {capteur3}; // création d'un tableau contenant tous les capteurs d'une zone
Zone zone2(capteursZone2, 1, 12);

//CapteurLumiereAnalogique capteursZone2[] = {capteur4, capteur5};
//Zone zone2(capteursZone2, 2, 12);

//Zone listeZones[] = {zone1, zone2}; // création d'un tableau contenant toutes les zones
//GestionZones gestionZones(listeZones, 2); // tableau de la liste des zones, nbr de zones
...
void envoyerMesures() {
  ...
  xmlData += "<capteur id_capteur='1' zone='1'>" + String(capteur1.lireValeur()) + "</capteur>";
  xmlData += "<capteur id_capteur='2' zone='1'>" + String(capteur2.lireValeur()) + "</capteur>";
  xmlData += "<capteur id_capteur='3' zone='2'>" + String(capteur3.lireValeur()) + "</capteur>";
